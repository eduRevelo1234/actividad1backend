            ...
            <div class="card-body">
                <form name="create_serie" action="" method="POST">
                    <div class="form-group row offset-2">
                        ...
                        <div class="col-5">
                            <input id="title" name="title" type="text" class="form-control" placeholder="Titulo" value="<?php if (isset($platformObject))
                    ...
                    <div class="form-group row margin-top offset-2">
                        ...
                        <div class="col-1">
                            <input id="idDirector" name="idDirector" type="text" class="form-control" placeholder="Id"
                                value="<?php if (isset($platformObject))
                                    echo $platformObject['name']; ?>">
                        </div>
                    </div>
                    <div class="form-group row margin-top offset-2">
                    ...
                    <div class="form-group row margin-top">
                        <div class="offset-6">
                            ...
                            <input class="btn btn-primary mb-2" type="submit" value="Guardar" name="saveBtn">
                        </div>
                    </div>
