            ...
            <div class="card-body">
                <form name="create_nationality" action="" method="POST">
                    <div class="form-floating mb-3">
                        <input id="nationalityName" name="nationalityName" type="text" required class="form-control"
                            placeholder="Country Name"
                            value="<?php if (isset($nationalityObject['name']))
                                echo $nationalityObject['name']; ?>"
                            autocomplete="off">
                        <label for="nationalityName">Nombre de la Nacionalidad</label>
                    </div>

                    <input type="hidden" name="nationalityId"
                        value="<?php if (isset($nationalityObject['id']))
                            echo $nationalityObject['id']; ?>">
                    <input type="hidden" name="nationalityNameCurrent"
                        value="<?php if (isset($nationalityObject['name']))
                            echo $nationalityObject['name']; ?>">
