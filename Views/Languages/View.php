...
<div class="container mt-4">
    <?php
        $idLanguage = isset($_GET['id']) ? $_GET['id'] : 0;
                ...
                <div class="card-body">
                    <form name="create_language" action="" method="POST">
                        <div class="form-floating mb-3">
                            <input id="languageName" name="languageName" type="text" class="form-control" placeholder="name@example.com" value="<?php if(isset($languageObject['name'])) echo $languageObject['name']; ?>" autocomplete="off">
                            <label for="languageName">Nombre del Idioma</label>
                        </div>

                        <div class="form-floating mb-3">
                            <input id="languageIsocode" name="languageIsocode" type="text" class="form-control" placeholder="name@example.com" value="<?php if(isset($languageObject['isocode'])) echo $languageObject['isocode']; ?>">
