...
<div class="container mt-4">
    <?php
        ...
        $nationalityObject = listNationalities();
        $sendData = false;
        ...
        if($sendData) 
        {
            ...
            {
                $nationalityResult = saveNationality($_POST['nationalityId'],$_POST['nationalityName'],$_POST['nationalityNameCurrent']);
            }
        }
        if(!$sendData)
        {
                ...
                <div class="card-body">
                    <form name="create_nationality" action="" method="POST">
                        <div class="form-floating mb-3">
                            <input id="nationalityName" name="nationalityName" type="text" class="form-control" placeholder="Country Name" value="<?php if(isset($nationalityObject)) echo $nationalityObject['name']; ?>">
                            <label for="nationalityName">Nombre de la Nacionalidad</label>
                        </div>
                        
                        <input type="hidden" name="nationalityId" value="<?php echo $idNationality; ?>">
                        <input type="hidden" name="nationalityNameCurrent" value="<?php echo $nationalityObject['name']; ?>">

                        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                            <input type="submit" value="Guardar" class="btn btn-success" name="saveBtn">
                            <br> 
                            <a class="btn btn-danger" href="ListNatio.php">Regresar</a>
                        </div>
                    </form>
                </div>
            </div>
    ...
    ?>
            ...
            ?>
                        <div class="alert alert-danger" role="alert">
                            ...
                            <br> 
                            <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                <a class="btn btn-primary" href="ListNatio.php">
                                    Regresar
                                </a>
                            </div>      
                        </div>
