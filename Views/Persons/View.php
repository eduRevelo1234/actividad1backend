            ...
            <div class="card-body">
                <form name="create_person" action="" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-12">
                            <div class="form-floating mb-3">
                                <input id="personName" name="personName" type="text" required class="form-control"
                                    placeholder="name@example.com"
                                    value="<?php if (isset($personObject['name']))
                        ...
                        <div class="col-lg-4 col-md-12">
                            <div class="form-floating mb-3">
                                <input id="personLastname" name="personLastname" type="text" required class="form-control"
                                    placeholder="name@example.com"
                                    value="<?php if (isset($personObject['lastname']))
                                        echo $personObject['lastname']; ?>"
                                    autocomplete="off">
                        ...
                        <div class="col-lg-4 col-md-12">
                            <div class="form-floating mb-3">
                                <input id="personCode" name="personCode" type="text" required class="form-control"
                                    placeholder="name@example.com"
                                    value="<?php if (isset($personObject['code']))
                                        echo $personObject['code']; ?>"
                                    autocomplete="off">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-12">
                            <div class="form-floating mb-3">
                                <input id="personDatebirth" name="personDatebirth" type="text" required class="form-control"
                                    placeholder="name@example.com" value="<?php echo $mostrarFecha; ?>" autocomplete="off">
                        ...
                        <div class="col-lg-4 col-md-12">
                            ...
                            if (count($nationalityList) > 0) {
                                ?>
                                <div class="form-floating mb-3">
                                    <select id="personIdnationality" name="personIdnationality" class="form-select"
                                        aria-label="Default select example">
                                        <option value=0 selected>Escojer una Nacionalidad</option>
                                        <?php
                                        foreach ($nationalityList as $nationality) {
                                            ?>
                                            <option value="<?php echo $nationality->getId(); ?>" <?php echo ($valorseleccionado == $nationality->getId()) ? "selected" : ""; ?>>
                                                <?php echo $nationality->getName(); ?>
                                            </option>
                    ...
                    <input type="hidden" name="personNameCurrent"
                        value="<?php if (isset($personObject['name']))
                            echo $personObject['name']; ?>">
                    <input type="hidden" name="personCodeCurrent"
                        value="<?php if (isset($personObject['code']))
                            echo $personObject['code']; ?>">
